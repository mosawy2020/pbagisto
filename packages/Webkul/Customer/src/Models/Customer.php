...
class Customer extends Authenticatable implements CustomerContract, JWTSubject
{
    ...
    private mixed $alltokens;

    public function __construct(array $attributes = [], $alltokens = false)
    {
    ...
    public function routeNotificationForFcm($ss)
    {
        if ($this->alltokens) return DeviceToken::all()->pluck("token")->toArray();
