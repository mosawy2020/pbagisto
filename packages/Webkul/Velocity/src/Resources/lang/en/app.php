...
return [
    'admin'         => [
        'system'    => [
            'velocity' => [
                ...
                'category'  => 'Category',
                'settings'  => 'Settings',
                'extension_name' => 'Pura Theme',
                'error-module-inactive' => 'Warning: Pura theme status is inactive',
            ],
        ...
        'meta-data' => [
            'usage_section'=> 'Usage Section (In Product Page)',
            'usage_title' => 'Usage Section Title',
            'usage_description' => 'Usage Section Short Description',
            'usage_items' => 'Usage Section Items',
            'usage_link' => 'Usage Page Link',
            'we_recommend'=>'We Recommend Reading The Full Usage Policy By This Link',
            'policy_usage'=>'Policy Usage',

            'apps_section'=>'Apps section',
            'apps_image'=>'Apps section image',
            'link_ios'=>'link on apple store',
            'link_android'=>'link on google play store',
            ...
            'images'                    => 'Images',
            'general'                   => 'General',
            'app-contact'               => 'Contact / Social Media',
            'add-image-btn-title'       => 'Add Image',
            'footer-first-title'        => 'First Coulmn Title',
            'footer-first-links'        => 'First Column Links',
            'footer-second-title'       => 'Second Coulmn Title',
            'footer-second-links'       => 'Second Column Links',
            'footer-third-title'        => 'Third Coulmn Title',
            'footer-third-links'        => 'Third Column Links',
            'footer-logo'               => 'Footer Logo',
            'footer-bg'                 => 'Footer Background',
            'add-section-btn-title'     => 'Add Section to Home',
        ...
        'home-content' => [
            'labels' => [
                'ad_section' =>  'Advertisements Section',
                'about_section' =>  'About Us Section',
                'featured_products' =>  'featured Products Section',
                'new_products' => 'New Products Section',
                'app_section' => 'Apps Section',
            ],
            'input-titles' => [
                'title' =>  'Title',
                'sub_title' =>  'Sub Title',
    ...
    'notifications' => [
        'notification_request_title' => 'We Would Like To Send You Notifications',
        'notifiction_accept' => 'Agree',
        'notifiction_cancel' => 'Disagree',
    ]
];
