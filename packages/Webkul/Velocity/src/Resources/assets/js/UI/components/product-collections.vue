<template>
  <div class="container-fluid">
    ...
    <template v-else-if="productCollections.length > 0">
      ...
      <div class="extra-header" v-if="productSubTitle">
        <h3 class="secondary-title" v-if="productSubTitle">{{ productSubTitle }}</h3>
        <a class="button" v-if="productButtonText" :href="productButtonLink">{{
          productButtonText
        }}</a>
      </div>
      ...
      <div class="row" :class="localeDirection">
        ...
        >
          <carousel-component
            ...
            :slidesPerPageXlg="slidesPerPageXlg"
            :slidesPerPageLg="slidesPerPageLg"
            :slidesPerPageMd="slidesPerPageMd"
            :slidesPerPageSm="slidesPerPageSm"
            :slidesPerPageXs="slidesPerPageXs"
            v-if="count != 0"
          >
            <slide
              :key="index"
