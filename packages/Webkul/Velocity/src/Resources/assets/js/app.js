...
Vue.component('product-share', () => import('@components/product-share'));
...
Vue.component('animated-accordion', () => import('@components/animated-accordion/animated-accordion'));
Vue.component('animated-accordion-item', () => import('@components/animated-accordion/animated-accordion-item'));

Vue.component('notification', () => import('@components/notifications/notification'));



// Vue.component('general-carousel', () => import('@components/general-carousel'));
// Vue.component('product-options-list', () => import('@components/product-options-list'));
...
Vue.component('header-top-offer', () => import('@components/header-top-offer'));
