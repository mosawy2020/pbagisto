    ...
    <script type="text/x-template" id="content-type-template">
        <div>
            ...
            <div v-else-if="content_type == 'categorytree'">
              @include ('velocity::admin.content.content-type.category-tree', ['status' => 'edit'])
            </div>
            <div v-else-if="content_type == 'page'">
              @include ('velocity::admin.content.content-type.page' , ['status' => 'edit'])
            </div>
            <div v-else-if="content_type == 'Url'">
                @include ('velocity::admin.content.content-type.url', ['status' => 'edit'])
            </div>
        </div>
    </script>
