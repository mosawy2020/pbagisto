...
class ContentRepository extends Repository
{
    ...
    {
//dd(app('Webkul\Velocity\Repositories\ContentRepository')->getAllContents());
    ...
    public function getAllContents()
    {
        ...
        $contentCollection = $query
            ->select(
                ...
                'velocity_contents.url',
                'velocity_contents.page',
                'velocity_contents.categories',
        ...
        foreach ($contentCollection as $content) {
            array_push($formattedContent, [
                ...
                'page_key'=>$content->page,
                'category'=> app('Webkul\Category\Repositories\CategoryRepository')->find(json_decode($content->categories)),
                'url'=>$content->url
