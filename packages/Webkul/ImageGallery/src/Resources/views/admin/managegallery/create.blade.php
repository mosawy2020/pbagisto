                ...
                <accordian :title="'{{ __('imagegallery::app.manage_gallery.create.accordian_title') }}'" :active="true">
                    <div slot="body">
                        <div class="control-group" :class="[errors.has('gallery_title') ? 'has-error' : '']">
                            ...
                            <input type="text" v-validate="'required'" class="control" id="title" name="title" value="{{ old('gallery_title') }}" data-vv-as="&quot;{{ __('Gallery Title') }}&quot;" v-slugify-target="'slug'"/>
                            <span class="control-error" v-if="errors.has('gallery_title')">@{{ errors.first('title') }}</span>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <textarea class="control" id="gallery_description" name="description">
                        ...
                        <div class="control-group">
                            ...
                            <image-wrapper input-name="brands" :images='[]'
