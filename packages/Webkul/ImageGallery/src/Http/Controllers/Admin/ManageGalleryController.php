    ...
    public function store()
    {
      ...
      //  dd(request());
        $this->validate(request(), [
            'title' => 'required|unique:manage_gallery_translations,title',
...
//if(request()->hasf)
    ...
    public function edit($id)
    {
        ...
        $categories = ImageGallery::where('status', 1)->get();
    ...
    public function update($id)
    {
       ...
       // dd(request());
        ...
        // $this->validate(request(), [
        //   $locale.'.title' => ['required', 'unique:manage_gallery_translations,title,' . $id],
        // 'gallery_code' => ['required', 'unique:manage_galleries,gallery_code,' . $id],
        // ]);
