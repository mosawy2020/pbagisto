                ...
                <div class="form-container">
                    ...
                    <accordian title="{{ __('admin::app.cms.pages.general') }}" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('content_title') ? 'has-error' : '']">
                                <label for="content_title" >{{ __('admin::app.cms.pages.content_title') }}</label>

                                <input type="text" class="control" name="content_title"  value="{{ old('content_title') }}" data-vv-as="&quot;{{ __('admin::app.cms.pages.page-title') }}&quot;">

                                <span class="control-error" v-if="errors.has('content_title')">@{{ errors.first('content_title') }}</span>
                            </div>
                    ...
                    <accordian title="{{ __('admin::app.cms.pages.tabs') }}" :active="true">
                        <div slot="body">
                            <faq-wrapper :faq-items="[]"    input-name="test"  :multiple="true" ></faq-wrapper>
                        </div>
                    </accordian>
