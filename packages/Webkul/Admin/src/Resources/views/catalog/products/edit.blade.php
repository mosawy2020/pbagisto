...
dd($product->bundle_options() );
//->with(['product', 'bundle_option_products', 'bundle_option_products.product'])->get());
                    ...
                    @if (count($customAttributes))
                        ...
                        <accordian title="{{ __($attributeGroup->name) }}"
                            ...
                            <div slot="body">
                                ...
                                $count++;
                            @endphp
                                @if($product->type=="bundle" && $count==1)
                                    <div class="control-group text" :class="[errors.has('bundle_price') ? 'has-error' : '']">
                                        <label for="bundle_price" class="required">
                                            {{trans('admin::app.datagrid.bundle_price')}}
                                        </label>
                                        <input type="number" required name="bundle_price"  class="control" aria-required="false"
                                        v-validate="'required'"
                                        data-vv-as="&quot;{{trans('admin::app.datagrid.bundle_price')}} &quot;"
                                        min="0"
                                        value="{{$product->bundle_price}}"
                                        >
                                        <span class="control-error" >
                                            @{{ errors.first('bundle_price') }}
                                        </span>
