...
@section('page_title')
    {{ __('admin::app.notification.title-plural')  }}
@stop
    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h1>{{ __('admin::app.notification.title-plural') }}</h1>
            </div>

            <div class="page-action">
                <a
                    href="{{ route('admin.notifications.fcm.create') }}"
        ...
        {!! view_render_event('bagisto.admin.notifications.list.before') !!}

        <div class="page-content">
            <datagrid-plus src="{{ route('admin.notifications.fcm.index') }}"></datagrid-plus>
        </div>

        {!! view_render_event('bagisto.admin.notifications.list.after') !!}
    </div>
@stop
