...
class suggestionServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../../publishable/assets' => public_path('themes/pura_theme/assets/suggestion'),
        ], 'public');
        ...
        $this->publishes([
            __DIR__ . '/../Resources/views/shop/pura_theme/header/index.blade.php' => resource_path('themes/pura_theme/views/layouts/header/index.blade.php'),
        ]);

        $this->publishes([
            __DIR__ . '/../Resources/views/shop/pura_theme/header/particals.blade.php' => resource_path('themes/pura_theme/views/UI/particals.blade.php'),
        ]);
