...
return [
    ...
    'footer' => [
        'subscribe-newsletter' => 'اشترك معنا في الرسائل البريدية.',
        'subscribe-title'      => 'النشرة البريدية' ,
        'subscribe'            => 'اشترك',
        'locale'               => 'اللغة',
        'currency'             => 'العملة',
    ],
    ...
    'products' => [
        ...
        'related-product-title'    => 'بعض من منتجات بيـــورا الأخرى',
        'related-product-subtitle' => 'قد',
        'related-product-subtitle2' => 'تُعجبكـــ',
