    ...
    'admin' => [
        'system'   => [
            'velocity' => [
                ...
                'category'  => 'الفئة',
                'settings'  => 'الإعدادات',
                'extension_name' => 'Pura موضوع',
                'error-module-inactive' => 'Warning: حالة سمة Pura غير نشطة',
            ],
        ...
        'meta-data' => [
            'usage_section'=> 'طريقة الاستخدام التي تظهر في صفحة المنتج',
            'usage_title' => 'عنوان طريقة الاستخدام',
            'usage_description' => 'شرح مبسط لطرق الاستخدام',
            'usage_items' => 'عناصر طرق الاستعمال',
            'usage_link' => 'رابط صفحة الاستخدام',
            'we_recommend'=>'ننصحكــ بقراءة سياسة الإستعمال كاملة من خلال الضغط على الأيقونة التالية',
            'policy_usage'=>'سياسة الإستعمال',

            'apps_section'=>'التطبيقات',
            'apps_image'=>'صوره مساحه التطبيقات',
            'link_ios'=>'رابط المتجر للايفون',
            'link_android'=>'رابط المتجر للاندرويد',
            'facebook'=>'فيسبوك',
            'twitter'=>'تويتر',
            'snapchat'=>'سناب شات',
            'instagram'=>'انستاجرام',
            ...
            'about'=>"نبذه عن الموقع",
            'text_ad'=>'اعلان نصى ',
            'add-image-btn-title' => 'إضافة صورة',
            'add-section-btn-title' => 'اضافة السيكسن الى الرئيسية',
            'footer-first-title' => 'عنوان العمود الاول',
            'footer-first-links' => 'روابط العمود الاول',
            'footer-second-title' => 'عنوان العمود الثاني',
            'footer-second-links' => 'روابط العمود الثاني',
            'footer-third-title' => 'عنوان العمود الثالث',
            'footer-third-links' => 'روابط العمود الثالث',
            'footer-logo' => 'لوجو الفوتر',
            'footer-bg' => 'خلفية الفوتر',
            'footer-middle' => [
                'about-us'  => 'About Us',
        ...
        'home-content' => [
            'labels' => [
                'ad_section' =>  'سيكشن الاعلانات',
                'about_section' =>  'سيكشن من نحن ',
                'featured_products' =>  'سيكسن المنتجات الهامة',
                'new_products' => 'سيكشن المنتجات الجديدة',
                'app_section' => 'سيكشن التطبيقات',
            ],
            'input-titles' => [
                'title' =>  'العنوان',
