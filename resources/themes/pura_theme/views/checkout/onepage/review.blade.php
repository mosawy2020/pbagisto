    ...
    <accordian :title="'{{ __('shop::app.checkout.onepage.summary') }}'" :active="true">
        ...
        <div slot="body">
                ...
                @foreach ($cart->items as $item)
                    ...
                    <div class="row col-12 no-padding">
                        <div class="col-2 max-sm-img-dimension">
                            <figure class="product-image-container" ><img src="{{ $productBaseImage['medium_image_url'] }}" alt="" /></figure>
                        </div>

                        <div class="col-10 product-details-content no-padding fs16">
                            ...
                            <div class="row col-12 quantity-summary">
            ...
            <div class="order-description row fs16 cart-details">
                {{-- <div class="col-lg-12 col-md-12 order-summary-container bottom pt0">
