@if ($velocityMetaData && $velocityMetaData->slider)
    <div class="slider-container">
        <slider-component
            ...
            default-banner="{{ asset('/themes/pura_theme/assets/images/banner.webp') }}"
            ...
            @else
                <img class="col-12 no-padding banner-icon" src="{{ asset('/themes/pura_theme/assets/images/banner.webp') }}" alt=""/>
            @endif    
