        ...
        <div class="row">
            <div class="col-lg-4 col-12 advertisement-container-block no-padding">
                <a @if (isset($one)) href="{{ $one }}" @endif aria-label="Advertisement">
                    <img
                        class="{{ $isLazyLoad ? 'lazyload' : '' }}"
                        @if (! $isLazyLoad) src="{{ asset('/themes/pura_theme/assets/images/big-sale-banner.webp') }}" @endif
                        data-src="{{ asset('/themes/pura_theme/assets/images/big-sale-banner.webp') }}" alt="" />
                </a>
            </div>
            ...
            <div class="col-lg-4 col-12 advertisement-container-block offers-ct-panel">
                <a @if (isset($two)) href="{{ $two }}" @endif aria-label="Advertisement">
                    <img
                        class="offers-ct-top {{ $isLazyLoad ? 'lazyload' : '' }}"
                        @if (! $isLazyLoad) src="{{ asset('/themes/pura_theme/assets/images/seasons.webp') }}" @endif
                        data-src="{{ asset('/themes/pura_theme/assets/images/seasons.webp') }}" alt="" />
                </a>
                ...
                <a @if (isset($three)) href="{{ $three }}" @endif aria-label="Advertisement">
                    <img
                        class="offers-ct-bottom {{ $isLazyLoad ? 'lazyload' : '' }}"
                        @if (! $isLazyLoad) src="{{ asset('/themes/pura_theme/assets/images/deals.webp') }}" @endif
                        data-src="{{ asset('/themes/pura_theme/assets/images/deals.webp') }}" alt="" />
                </a>
            </div>
            ...
            <div class="col-lg-4 col-12 advertisement-container-block no-padding">
                <a @if (isset($four)) href="{{ $four }}" @endif aria-label="Advertisement">
                    <img
                        class="{{ $isLazyLoad ? 'lazyload' : '' }}"
                        @if (! $isLazyLoad) src="{{ asset('/themes/pura_theme/assets/images/kids.webp') }}" @endif
                        data-src="{{ asset('/themes/pura_theme/assets/images/kids.webp') }}" alt="" />
                </a>
            </div>
        </div>
    </div>
