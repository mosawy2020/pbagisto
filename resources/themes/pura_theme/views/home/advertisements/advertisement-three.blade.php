    ...
    <div class="container-fluid advertisement-three-container">
        <div class="row">
            <a @if (isset($one)) href="{{ $one }}" @endif class="col-lg-6 col-md-12 no-padding">
                <img
                    class="full-width {{ $isLazyLoad ? 'lazyload' : '' }}"
                    @if (! $isLazyLoad) src="{{ asset('/themes/pura_theme/assets/images/headphones.webp') }}" @endif
                    data-src="{{ asset('/themes/pura_theme/assets/images/headphones.webp') }}" alt="" />
            </a>
            ...
            <div class="col-lg-6 col-md-12 second-panel">
                <a @if (isset($two)) href="{{ $two }}" @endif class="row top-container">
                    <img
                        class="col-12 pr0 {{ $isLazyLoad ? 'lazyload' : '' }}"
                        @if (! $isLazyLoad) src="{{ asset('/themes/pura_theme/assets/images/watch.webp') }}" @endif
                        data-src="{{ asset('/themes/pura_theme/assets/images/watch.webp') }}" alt="" />
                </a>
                <a @if (isset($three)) href="{{ $three }}" @endif class="row bottom-container">
                    <img
                        class="col-12 pr0 {{ $isLazyLoad ? 'lazyload' : '' }}"
                        @if (! $isLazyLoad) src="{{ asset('/themes/pura_theme/assets/images/kids-2.webp') }}" @endif
                        data-src="{{ asset('/themes/pura_theme/assets/images/kids-2.webp') }}" alt="" />
                </a>
            </div>
        </div>
    </div>
