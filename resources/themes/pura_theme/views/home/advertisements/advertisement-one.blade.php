        ...
        <div class="container-fluid advertisement-one">
            ...
            {{-- <div
                ...
                {{-- <div class="col offers-ct-panel">
                    ...
                    <div class="row">
                        <div class="col-12 offers-ct-bottom"
                       
                            style="background-image: url('{{ Storage::url($advertisementOne['4']) }}')"> 
                        </div>
                    </div>
                ...
                <div
                    ...
                    {{-- style="background-image: url('{{ Storage::url($advertisementOne['image_5']) }}')"> --}}
                </div>
            </div>
        </div>
    @endif
