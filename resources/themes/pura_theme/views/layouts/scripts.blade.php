<script type="text/javascript" src="{{ asset(mix('/js/manifest.js', 'themes/pura_theme/assets')) }}"></script>

<script type="text/javascript" src="{{ asset(mix('/js/velocity-core.js', 'themes/pura_theme/assets')) }}"></script>

<script type="text/javascript" src="{{ asset(mix('/js/components.js', 'themes/pura_theme/assets')) }}"></script>
