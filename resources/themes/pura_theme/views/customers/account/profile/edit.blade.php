...
@section('page-detail-wrapper')
    ...
    <form
        ...
        <div class="account-table-content">
            ...
            <div :class="`row justify-content-center ${errors.has('first_name') ? 'has-error' : ''}`">
                <label class="col-md-2 mandatory">
            ...
            <div :class="`row justify-content-center ${errors.has('last_name') ? 'has-error' : ''}`">
                <label class="col-md-2 mandatory">
            ...
            <div :class="`row justify-content-center ${errors.has('gender') ? 'has-error' : ''}`">
                <label class="col-md-2 mandatory">
            ...
            <div :class="`row justify-content-center ${errors.has('date_of_birth') ? 'has-error' : ''}`">
            ...
            <div class="row justify-content-center image-container {!! $errors->has('image.*') ? 'has-error' : '' !!}">
                <label class="col-md-2">
            ...
            <button
                type="submit"
                class="theme-btn btn-to-end mb20">
