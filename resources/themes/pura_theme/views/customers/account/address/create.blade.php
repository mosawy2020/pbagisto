    ...
    {!! view_render_event('bagisto.shop.customers.account.address.create.before') !!}
        ...
        <form method="post" action="{{ route('customer.address.store') }}" @submit.prevent="onSubmit">
            <div class="account-table-content mb-2">
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('company_name') ? 'has-error' : '']">
                    <label class="col-md-2" for="company_name">{{ __('shop::app.customer.account.address.create.company_name') }}</label>
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('first_name') ? 'has-error' : '']">
                    <label class="col-md-2" for="first_name" class="mandatory">{{ __('shop::app.customer.account.address.create.first_name') }}</label>
                    <div class="col-md-9">
                        <input
                            class="control"
                            type="text"
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('last_name') ? 'has-error' : '']">
                    <label class="col-md-2" for="last_name" class="mandatory">{{ __('shop::app.customer.account.address.create.last_name') }}</label>
                    <div class="col-md-9">
                        <input
                            class="control"
                            type="text"
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('vat_id') ? 'has-error' : '']">
                    <label class="col-md-2" for="vat_id">{{ __('shop::app.customer.account.address.create.vat_id') }}
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('address1[]') ? 'has-error' : '']">
                    <label class="col-md-2" for="address_0" class="mandatory">{{ __('shop::app.customer.account.address.create.street-address') }}</label>
                    <div class="col-md-9">
                        <input
                            class="control"
                            id="address_0"
                ...
                @if (core()->getConfigData('customer.settings.address.street_lines') && core()->getConfigData('customer.settings.address.street_lines') > 1)
                    @for ($i = 1; $i < core()->getConfigData('customer.settings.address.street_lines'); $i++)
                        <div class="control-group row justify-content-center" style="margin-top: -25px;">
                            <input
                                class="control"
                                id="address_{{ $i }}"
                                type="text"
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('city') ? 'has-error' : '']">
                    <label class="col-md-2" for="city" class="mandatory">{{ __('shop::app.customer.account.address.create.city') }}</label>
                    <div class="col-md-9">
                        <input
                            type="text"
                            class="control"
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('postcode') ? 'has-error' : '']">
                    <label class="col-md-2" for="postcode" class="{{ core()->isPostCodeRequired() ? 'mandatory' : '' }}">{{ __('shop::app.customer.account.address.create.postcode') }}</label>
                    <div class="col-md-9">
                        <input
                            class="control"
                            type="text"
                ...
                <div class="control-group row justify-content-center" :class="[errors.has('phone') ? 'has-error' : '']">
                    <label class="col-md-2" for="phone" class="mandatory">{{ __('shop::app.customer.account.address.create.phone') }}</label>
                ...
                <div class="button-group">
                    <button class="theme-btn btn-to-end" type="submit">
