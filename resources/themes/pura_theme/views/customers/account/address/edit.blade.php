    ...
    <form method="post" action="{{ route('customer.address.update', $address->id) }}" @submit.prevent="onSubmit">
        <div class="account-table-content mb-2">
            ...
            <div class="control-group row justify-content-center" :class="[errors.has('company_name') ? 'has-error' : '']">
                <label class="col-md-2" for="company_name">{{ __('shop::app.customer.account.address.edit.company_name') }}</label>
            ...
            <div class="control-group row justify-content-center" :class="[errors.has('address1[]') ? 'has-error' : '']">
                <label class="col-md-2" for="address_0" class="mandatory">{{ __('shop::app.customer.account.address.edit.street-address') }}</label>
